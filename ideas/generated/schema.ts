...
export class IdeaMinted extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save IdeaMinted entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type IdeaMinted must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("IdeaMinted", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): IdeaMinted | null {
    return changetype<IdeaMinted | null>(
      store.get_in_block("IdeaMinted", id.toHexString()),
    );
  }

  static load(id: Bytes): IdeaMinted | null {
    return changetype<IdeaMinted | null>(
      store.get("IdeaMinted", id.toHexString()),
    );
  }
...
export class OfferPlaced extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save OfferPlaced entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type OfferPlaced must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("OfferPlaced", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): OfferPlaced | null {
    return changetype<OfferPlaced | null>(
      store.get_in_block("OfferPlaced", id.toHexString()),
    );
  }

  static load(id: Bytes): OfferPlaced | null {
    return changetype<OfferPlaced | null>(
      store.get("OfferPlaced", id.toHexString()),
    );
  }
...
export class OfferWithdrawn extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type OfferWithdrawn must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("OfferWithdrawn", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): OfferWithdrawn | null {
    return changetype<OfferWithdrawn | null>(
      store.get_in_block("OfferWithdrawn", id.toHexString()),
    );
  }

  static load(id: Bytes): OfferWithdrawn | null {
    return changetype<OfferWithdrawn | null>(
      store.get("OfferWithdrawn", id.toHexString()),
    );
  }
